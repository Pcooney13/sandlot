...
if ($post->post_type === 'tribe_events') :
	...
	<div class="tribe-events-meta-group tribe-events-meta-group-details">
		<h2 class="font-bold uppercase text-sm tracking-wider"> <?php esc_html_e( 'Details', 'the-events-calendar' ); ?> </h2>
		<dl>
			...
			// Single day events
				...
				?>
				<div class="flex">
					<p class="font-normal"> <?php esc_html_e( 'Date:', 'the-events-calendar' ); ?> </p>
					<abbr class="" title="<?php echo esc_attr( $start_ts ); ?>"> <?php echo esc_html( $start_date ); ?> </abbr>
				</div>
				<p class="font-normal"> <?php echo esc_html( $time_title ); ?> </p>
				<dd>
