...
<!--Title-->
<div class="hero w-full m-0 relative p-0 flex flex-col justify-center py-20 md:py-0 md:aspect-blog">
	<div class="container max-w-6xl mx-auto mb-16 md:mb-32">
		...
		<h1 class="text-center mx-6 relative z-20 font-gotham font-bold text-2xl lg:text-5xl mt-4"><?php echo get_the_title(); ?></h1>
...
<div class="container px-4 relative md:px-0 max-w-6xl mx-auto -mt-16 md:-mt-32">
	<div class="mx-0 sm:mx-6">
		<div class="w-full rounded-t">
			<div class="container w-full max-w-6xl mx-auto bg-white bg-cover rounded" style="background-image:url('<?php echo get_the_post_thumbnail_url();?>'); height: 75vh;"></div>	
		</div>
	</div>
</div>
...
<div class="container max-w-5xl mx-auto -mt-32">
	<div class="mx-0 sm:mx-6 relative">
		<div id="progressBar" class="h-2 bg-gradient-to-r from-orange to-bright-orange sticky top-[-8px] z-10 w-0 transform translate-y-2 overflow-x-hidden"></div>
		<div id="BlogScroll" class="relative shadow-md bg-white w-full p-8 md:p-24 leading-normal text-xl text-gray-800 leading-normal font-gotham">				
            <!--Post Content-->
            <!--Lead Para-->
	...
	<div class="flex flex-wrap -mx-4">
		<div class="w-full md:w-1/3 px-2 pb-12">
			<div class="h-full bg-white rounded overflow-hidden shadow-md hover:shadow-lg relative smooth">
				<a href="/hello-world" class="no-underline hover:no-underline">
...
<script>
	...
	function handleScroll() {
	    const BlogScroll = document.getElementById("BlogScroll").offsetHeight;
		const progressBar = document.getElementById("progressBar");
	    const winScroll = document.body.scrollTop || document.documentElement.scrollTop;
	    const height = document.documentElement.scrollHeight - document.documentElement.clientHeight;  
	    const scrolled = ((winScroll / BlogScroll) * 100) - 25;
		if (scrolled > 100) {
		...
		console.log('BlogScroll', BlogScroll.offsetHeight);
